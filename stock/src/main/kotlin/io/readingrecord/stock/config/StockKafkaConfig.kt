package io.readingrecord.stock.config
...
class StockKafkaConfig {
    ...
    fun consumerFactory(): ConsumerFactory<String, OrderEvent> {
        ...
        configProps[JsonDeserializer.TRUSTED_PACKAGES] = "io.readingrecord.*"
        configProps[JsonDeserializer.VALUE_DEFAULT_TYPE] = OrderEvent::class.java.name
